...
#
# Script generated by Vivado on Wed Mar 18 02:49:50 AEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : output_buffer.sh
...
#
# Usage        : output_buffer.sh
#                output_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_buffer.sh [-rerun]
#                output_buffer.sh [-reset_run]
#                output_buffer.sh [-clean]
#                output_buffer.sh [-reset_log]
#                output_buffer.sh [-help]
#
...
#                script (type 'output_buffer.sh -help' for more information).
#
...
# script info
echo -e "output_buffer.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../Games/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../Games/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../Games/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_buffer xil_defaultlib.glbl -o output_buffer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_buffer_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dinal/image_processing/image_processing.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key output_buffer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc output_buffer_simv.daidir vcs_lib c.obj)
...
usage()
{
  msg="Usage: output_buffer.sh [-help]\n\
Usage: output_buffer.sh [-step]\n\
Usage: output_buffer.sh [-lib_map_path]\n\
Usage: output_buffer.sh [-rerun]\n\
Usage: output_buffer.sh [-reset_run]\n\
Usage: output_buffer.sh [-clean]\n\
Usage: output_buffer.sh [-reset_log]\n\
Usage: output_buffer.sh [-keep_index]\n\
Usage: output_buffer.sh [-noclean_files]\n\n\
